    ...
    <div className="sticky top-0 inset-x-0 z-20 bg-white border-y px-4 sm:px-6 lg:px-8 lg:hidden dark:bg-neutral-800 dark:border-neutral-700">
      <div className="flex items-center py-2">
        ...
        <ol className="ms-3 flex items-center whitespace-nowrap">
          <Link className="flex items-center text-sm text-gray-800 dark:text-neutral-400" href='/dashboard'>
            Learnflow
          ...
          <li className="text-sm font-semibold text-gray-800 truncate dark:text-neutral-400 capitalize" aria-current="page">
            {page || 'Dashboard'}
          </li>
        </ol>
        {/* <!-- End Breadcrumb --> */}
